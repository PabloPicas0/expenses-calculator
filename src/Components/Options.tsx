...
const Options = () => {
  return (
    <form className="options">
      ...
      <input type="text" placeholder="Description" className="input-base" />
      <input type="number" placeholder="Ammount" min={0} className="input-base" />

      <button className="icon-button" aria-label="submit">
